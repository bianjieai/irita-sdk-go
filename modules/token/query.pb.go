...
import (
	...
	types1 "github.com/bianjieai/irita-sdk-go/types"
...
func (m *QueryFeesResponse) GetIssueFee() github_com_bianjieai_irita_sdk_go_types.Coin {
	if m != nil {
		return m.IssueFee
	}
	return github_com_bianjieai_irita_sdk_go_types.Coin{}
}

func (m *QueryFeesResponse) GetMintFee() github_com_bianjieai_irita_sdk_go_types.Coin {
	if m != nil {
		return m.MintFee
	}
	return github_com_bianjieai_irita_sdk_go_types.Coin{}
...
var fileDescriptor_ec043bcd18c4056e = []byte{
	...
	,
}
